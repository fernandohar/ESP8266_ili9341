...
class Avatar {
  ...
  public:
    ...
    const uint8_t *mask;
    const uint16_t* bitmaps [10]; //suppose at most 10 frames per avatar;
...
//      Serial.print("getBitmap currentFrame: ");
//      Serial.println(currentFrame);
    ...
    bool isPointWithinBound(uint16_t targetX, uint16_t targetY) {

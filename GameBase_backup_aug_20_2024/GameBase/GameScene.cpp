...
void GameScene  :: renderScene() {
  ...
  for (int i  = 0; i < numAvatar;  ++i) {
    ...
    String msg = "renderableAvatar # " + numRenderableAvatar + 
                 "  minX, minY: [" + renderableMinx[numRenderableAvatar] + 
                 ", " + renderableMiny[numRenderableAvatar] + "] maxX, maxY: [" + 
                 renderableMaxx[numRenderableAvatar] + ", " +  renderableMaxy[numRenderableAvatar] + "]";
    Serial.println(msg);
#endif
